...
const Promises = () => {
  return (
    <div class="font-mitr">
        <h1 class = "font-playball text-7xl text-amber-950 text-center pt-10 font-semibold">Our Promises</h1>
        <p class = "text-center pb-7">From Our Kitchen to Your Heart, Always Fresh</p>
        <div class="min-h-50 w-full bg-pink-100 flex justify-center gap-15 border-b-2 border-t-2">
